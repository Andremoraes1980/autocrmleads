...
// === WhatsApp status bridge (Provider -> Backend) — canônico em waStatus ===
...
app.use((req, res, next) => {
  if (req.path === '/healthz') return next(); // não logar healthcheck
  // ... seu log atual ...
  next();
});
